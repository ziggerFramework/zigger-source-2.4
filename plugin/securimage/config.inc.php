...
return array(
    ...
    'image_width'      => 140,       // width of captcha image in pixels
    'image_height'     => 45,       // height of captcha image in pixels
    'code_length'      => 5,         // # of characters for captcha code
    'image_bg_color'   => '#f7f7f7', // hex color for image background
    'text_color'       => '#333333', // hex color for captcha text
    'line_color'       => '#dddddd', // hex color for lines over text
    'noise_color'      => '#707070', // color of random noise to draw under text
    'num_lines'        => 0,         // # of lines to draw over text
    'noise_level'      => 10,         // how much random noise to add (0-10)
    'perturbation'     => 0.2,       // distoration level
