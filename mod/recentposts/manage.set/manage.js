ph_mod_recentposts_manage = {
    ...
    'set_recent_write_submit' : function() {
        ...
        $('body.mod-board-manage form[name=board-writeForm]').on({
            'submit' : function() {
                    ...
                    switch (success) {
                        ...
                        case 'alert->location' :
                            ...
                            $.ajax({
                                ...
                                'async' : false,
                                'cache' : false,
                                'data' : $('body.mod-board-manage form[name=board-writeForm').serialize(),
                                'dataType' : 'html',
        ...
        $(document).off('click', 'body.mod-board-manage #del-btn');
        $(document).on('click', 'body.mod-board-manage #del-btn', function(e) {
            e.preventDefault();

            var $form = $('body.mod-board-manage #board-readForm');
    ...
    'set_recent_ctrl_submit' : function() {
        ...
        $(document).off('click', 'body.mod-board-manage #board_ctrpopForm #delete-btn');
        $(document).off('click', 'body.mod-board-manage #board_ctrpopForm #copy-btn');
        $(document).off('click', 'body.mod-board-manage #board_ctrpopForm #move-btn');
                ...
                switch (success) {
                    ...
                    case 'alert->reload' :
                        ...
                        $.ajax({
                            ...
                            'async' : false,
                            'cache' : false,
                            'data' : $('body.mod-board-manage form#board_ctrpopForm').serialize(),
                            'dataType' : 'html',
                            'success' : function(data){
                                valid.success($form, success, opt);
                            }
...
$(function() {
    ph_mod_recentposts_manage.init();
});