<form <?php echo $this->form(); ?>>
	...
	<ul id="comm-list">
		...
		<li class="comm-list-li <?php echo ($list['rn'] > 0) ? 'reply' : ''; ?>">
			...
			<div class="info">
				<span class="writer">
					<?php if ($list['rn'] > 0) { ?><img src="<?php echo MOD_BOARD_DIR; ?>/manage.set/images/reply-ico.png" /><?php } ?>

                    <img src="<?php echo MOD_BOARD_DIR; ?>/manage.set/images/cmt-name-ico.png" class="ico" />
	...
	<!-- 대댓글 입력 & 댓글 수정 Clone -->
	<div id="comm-re-form">
		<img src="<?php echo MOD_BOARD_DIR; ?>/manage.set/images/reply-ico.png" class="rep-ico" />
		<?php if ($is_guest_form_show) { ?>
		<div class="gue-writer">
